...
| `<tu-código-fuente>/`        | Código de la aplicación                                   | Para implementar |
| `<tu-carpeta-de-tests>/`     | Tests automáticos                                         | Para verificar |

> Nota: las rutas de código y tests dependen de tu stack. Consúltalas en
