...
> "Investiga cómo serializar el modelo en `src/domain.py`. Escribe tus
> hallazgos en `progress/research_serializacion.md`. Tu respuesta a mí debe ser solo:
> `done -> progress/research_serializacion.md` o un mensaje de bloqueo."

> **En práctica:** tras una sesión real los informes quedan en
...
- ❌ Editar archivos de código fuente o tests.
